...
class JobAPI(abc.ABC):
    ...
    @abc.abstractmethod
    def get_vacancion(self, keyword:str, page: int):
...
class hh_API(JobAPI):
    ...
    def get_vacancion(self, keyword: str, per_page: int, page: int):
...
if __name__ == "__main__":
    hh_api = hh_API()
    vacancies = (hh_api.get_vacancion("Python", 100, 2))
    try:
        for vacan in vacancies:
            salary = vacan['salary']
            ...
            pprint(f"Название вакансии: {vacan['name']},"
